<script>
	...
	const features = [
		...
		{
			title: "Ship dates",
			description: "Make a note of the ETD, ETA, and invoice dates for each purchase order.",
			icon: IconCalendar
		},
		{
			title: "PO details",
			description: "Includes details for each PO, including customer PO and booking number.",
			icon: IconCheck
		}
	]
</script>
